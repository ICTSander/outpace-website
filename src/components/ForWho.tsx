...
const branches = [
  {
    ...
    description: "Meer APK-afspraken, onderhoudsklanten en reparatieverzoeken via Google. Wij zorgen dat lokale automobilisten jou als eerste vinden.",
    bg: "bg-accent", iconBg: "bg-white/10", iconColor: "text-white",
    bar: "bg-yellow", titleColor: "text-white", bodyColor: "text-white/60",
  },
  {
    icon: Scissors,
    title: "Kappers & Barbershops",
    description: "Vul je agenda met nieuwe klanten. Online boeken, zichtbaar worden op Google Maps en een stijlvolle website die bij je salon past.",
    bg: "bg-yellow", iconBg: "bg-navy", iconColor: "text-white",
    bar: "bg-navy", titleColor: "text-navy", bodyColor: "text-navy/60",
  },
  {
    icon: TreePine,
    title: "Hoveniers & Tuinbedrijven",
    description: "Van tuinaanleg tot onderhoud — wij brengen de juiste klanten bij jou. Seizoensgebonden campagnes en lokale vindbaarheid.",
    bg: "bg-navy-light", iconBg: "bg-accent", iconColor: "text-white",
    bar: "bg-accent", titleColor: "text-white", bodyColor: "text-white/55",
  },
];
